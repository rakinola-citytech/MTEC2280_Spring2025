...
||          "String Version"              ||
||||||||||||||||||||||||||||||||||||||||||||     
- Example of sending a String of Comma Separated Values via UART to Processing.
- We are using the ASCII character '/n', aka "New Line", aka "Line Feed" to signal end of transmitted message. 
- Data is sent via Serial.print() INSTEAD of Serial.write(), as we did in the past example.
<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
*/
